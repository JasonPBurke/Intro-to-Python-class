...
miles = float(input('OK Nathan, how many miles do you want',
...
if miles < 0:
    for count in range(3):
        print('ERROR: You must inter a valid distance.')
    else:
        print('Nathan, there are', format(miles_to_kilometers, '.2f'),
            'kilometers for every',\
            miles, 'miles.  Pretty Cool!')
print()
    
    
# get temp in F to be converted to C
F = float(input("Give me a temperature in farenheit and I'll",
...
if gallons < 0:
    ...
    print('You get', format(liters, '.2f'), 'liters for every'
          , gallons, 'gallons.')
    print()
    

#~input # of pounds to be converted to kilograms
pounds = float(input("Give me a number of pounds and I'll",
...
if inches < 0:
    ...
    print ('You have', format(centimeters, '.2f'), 'centimeters in',
           inches, 'inches.  Good bye for now!')
    print()               
